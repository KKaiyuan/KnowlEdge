    ...
    return (
        <div className='FlashcardsPracticePage'>
            <div className='FlashcardsPracticeHeader'>
                <button className = "FlashcardsPracticeGoBackButton" onClick={() => navigate('/studysets')}>Go Back</button> {/* TODO: figure how how to type the left arrow <-- in html */}
                <h1>Flashcards Practice</h1>
            </div>
            <div className='FlashcardsPracticeBody'>
                <div className='FlashcardsPracticeCardDisplay'>
                    <PracticeFlashcard flashcard={cards.at(currentCardIndex)} key={currentCardIndex /* TODO: check this! */} />
                </div>
            </div>
            <div className='FlashcardsPracticeControlPanel'>
                <button className = "FlashcardsPracticeButtonPrevious" onClick={() => handleButtonPrevious()}>Previous</button> {/* TODO: figure how how to type the left arrow <-- in html */}
                <button className = "FlashcardsPracticeButtonNext" onClick={() => handleButtonNext()}>Next</button> {/* TODO: figure how how to type the left arrow --> in html */}
            </div>
        </div>
    );
