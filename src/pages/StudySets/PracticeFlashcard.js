  ...
  return (
    ...
    >
      <div className="front" ref={frontEl}>
        <div className="cardID">Card No. {flashcard.id}</div>
        <div
        ...
        >
          ...
          <form className="definitionDisplayForm">
            <input
              type="text"
              id="definitionDisplay"
              name="definitionDisplay"
              onChange={handleSetDefinition}
              value={definition} /* onKeyDown={(e) => e.preventDefault()} */
            ></input>
          </form>
        </div>
        ...
        >
          ...
          <form className="termDisplayForm">
            <input
              ...
              value={term} /* onKeyDown={(e) => e.preventDefault()} */
            ></input>
          </form>
        </div>
